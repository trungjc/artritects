...
class ControlPanel {
	...
	function add_menu() {
	add_theme_page('A+ Settings', 'A+ Settings', 8, "vnh", array(&$this, 'optionsmenu'));
	}
...
?>
    ...
    <div id="tab2">       
       ...
       <hr/>
        <!--main categories-->
        <fieldset class="nw-field" style="height:400px;" >
        <legend class="nw-legend"></legend>
            <p>
			<?php _e('chọn Categories (*)','vnh')?><br class="clear" />
			
            <select multiple name="m_cat[]" id="m_cat" style="width:150px;height:260px;">
